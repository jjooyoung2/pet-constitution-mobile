        ...
        <View style={styles.mainContainer}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.introText}>
              오행 체질 검사는 아이의 기질과 장부 균형(목ㆍ화ㆍ토ㆍ금ㆍ수)을 점수화 해 주체질과 보조 체질을 도출합니다.{"\n"}
              {"\n"}
              주체질은 현재 몸의 중심 경향, 보조 체질은 상황에 따라 드러나는 보완 성향을 뜻합니다.{"\n"}
              {"\n"}
              결과는 식단 선택, 계절 관리, 재활ㆍ침구ㆍ한약 처방의 방향을 정하는 지침으로 활용됩니다.
            </Text>
          </View>
